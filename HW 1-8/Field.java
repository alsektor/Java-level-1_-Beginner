...
class Field {
    ...
    //var img = new Image();
    //img.src = "ali.png";
    //ImageIcon ali = new ImageIcon( "ali.png" ) ;
    //ImageIcon mali = new ImageIcon( "tick.png" ) ; 
    //String filename = "ali";
    //Image image = ImageIO.read(new File("ali.png"));
    //Image myimg=Image.createImage("ali.png");
    
    //public void loadImage(String src) {
   // img = new ImageIcon("ali.png").getImage();
   // }
    ...
    public void paint(Graphics g) {
          img = new ImageIcon("ali.png").getImage();
          img1 = new ImageIcon("mali.png").getImage();
        ...
        for (int y = 0; y < FIELD_SIZE; y++) {
            for (int x = 0; x < FIELD_SIZE; x++) {
                if (field[x][y] == HUMAN_DOT) {
                    ...
                    g.drawImage(img1,x*CELL_SIZE+CELL_SIZE/4, y*CELL_SIZE+CELL_SIZE/4,null);
                 ...
                 if (field[x][y] == AI_DOT) {
                     g.drawImage(img,x*CELL_SIZE+CELL_SIZE/4, y*CELL_SIZE+CELL_SIZE/4,null);
                }
            }
        }
    }
